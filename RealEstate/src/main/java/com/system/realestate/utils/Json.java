package com.system.realestate.utils;
...
public class Json extends HashMap<String, Object> {
    ...
    public static String fail(String operate, String message) {
        return new Json(operate,false, DEFAULT_FAIL_CODE, message,null).toString();
    }
